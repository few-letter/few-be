...
@Component
class NewsCrawlerInsideEVs(
    private val generatorRestTemplate: RestTemplate,
) : BaseNewsCrawler(generatorRestTemplate) {
    companion object {
        private const val PRESS_NAME = "InsideEVs"
        private const val RSS_URL = "https://insideevs.com/rss/articles/all/"
    }
    ...
    override fun getNewsUrls(
        ...
        logger.info { "InsideEVs 뉴스 링크를 수집합니다." }
