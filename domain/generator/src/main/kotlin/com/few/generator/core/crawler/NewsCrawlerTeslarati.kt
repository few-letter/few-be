...
@Component
class NewsCrawlerTeslarati(
    private val generatorRestTemplate: RestTemplate,
) : BaseNewsCrawler(generatorRestTemplate) {
    companion object {
        private const val PRESS_NAME = "Teslarati"
        private const val RSS_URL = "https://www.teslarati.com/feed/"
    }

    override fun getAvailableTopics(): List<String> = listOf("tesla")

    override fun getNewsUrls(
        topic: String,
        limit: Int,
    ): List<String> {
        logger.info { "Teslarati 뉴스 링크를 수집합니다." }
