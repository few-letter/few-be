...
@Component
class NewsCrawlerGreenCar(
    private val generatorRestTemplate: RestTemplate,
) : BaseNewsCrawler(generatorRestTemplate) {
    companion object {
        private const val PRESS_NAME = "Green Car Reports"
        private const val RSS_URL = "https://feeds.highgearmedia.com/?sites=GreenCarReports"
    }

    override fun getAvailableTopics(): List<String> {
        return listOf("ev") // 친환경 자동차 관련 뉴스만 다룸
    }
    ...
    override fun getNewsUrls(
        ...
        logger.info { "Green Car Reports 뉴스 링크를 수집합니다." }
