...
class PromptGenerator(
    ...
    fun toKoreanHighlightText(summary: String): Prompt {
        ...
        val userPrompt =
            """
            ## Instructions
            1. 아래 Input에서 [] 괄호 안에 들어있는 내용 중에서 강조하고 싶은 하이라이트 텍스트를 추출해주세요.
            2. 하이라이트 텍스트는 한 문장으로 작성하되, 너무 길면(10자 이상) 문장의 일부를 발췌해서 추출해주세요.
            3. 본문에 있는 문장과 정확하게 일치해야 합니다.
            4. 다시 한번 강조: 아래 Input에서 주어지는 문장과 정확하게 일치해야 합니다. 또한, 반드시 문장 형태가 아니어도 됩니다. 단어 또는 문장 중 일부 키워드가 될 수도 있습니다.
