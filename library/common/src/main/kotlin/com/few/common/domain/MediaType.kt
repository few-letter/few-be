...
enum class MediaType(
    ...
    HANKYUNG(4, "한국경제", listOf("hankyung", "wowtv.co.kr")),
    ...
    MONEY_TODAY(18, "머니투데이", listOf("mt.co.kr")),
    ...
    NEWSIS(40, "뉴시스", listOf("newsis.com")),
    THESCOOP(41, "더스쿠프", listOf("thescoop.co.kr")),
    BUSAN(42, "부산일보", listOf("busan.com")),
    SISAJOURNAL(43, "시사저널", listOf("sisajournal.com")),
    HANI(44, "한겨레", listOf("hani.co.kr")),
    KYEONGGI(45, "경기일보", listOf("kyeonggi.com")),
    KBC(46, "KBC", listOf("ikbc.co.kr")),
    KADO(47, "강원도민일보", listOf("kado.net")),
    MUNHWA(48, "문화일보", listOf("munhwa.com")),
    KORMEDI(49, "코메디닷컴", listOf("kormedi.com")),
    MBN(50, "MBN", listOf("mbn.co.kr")),
    MEDIATODAY(51, "미디어오늘", listOf("mediatoday.co.kr")),
    KOOKJE(52, "국제신문", listOf("kookje.co.kr")),
    DAEJONILBO(53, "대전일보", listOf("daejonilbo.com")),
    OHMYNEWS(54, "오마이뉴스", listOf("ohmynews.com")),
    MONEYS(55, "머니S", listOf("moneys.co.kr")),
