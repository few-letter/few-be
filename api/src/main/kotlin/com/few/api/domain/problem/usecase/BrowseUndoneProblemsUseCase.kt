...
class BrowseUndoneProblemsUseCase(
    ...
    fun execute(useCaseIn: BrowseUndoneProblemsUseCaseIn): BrowseProblemsUseCaseOut {
        ...
        val subscriptionProgresses =
            problemSubscriptionService
                .browseWorkbookIdAndProgress(
         ...
         */
        val sentArticleIds =
            subscriptionProgresses
                .flatMap { subscriptionProgress ->
         ...
         */
        val allProblemIdsAndArticleIdsToBeSolved =
            problemDao.selectProblemIdByArticleIds(
        ...
        val submittedProblemIds =
            submitHistoryDao
                .selectProblemIdByProblemIds(
                    SelectSubmittedProblemIdsQuery(useCaseIn.memberId, allProblemIdsToBeSolved),
                ).problemIds

        val unsubmittedProblemIdAndArticleIds: Map<Long, List<Long>> =
            allProblemIdsAndArticleIdsToBeSolved
